...
public interface TicketRepo extends JpaRepository<Ticket, Integer> {
    ...
    @Query("SELECT t FROM Ticket t WHERE t.ticket_seat = :ticket_seat")
    Optional<Ticket> findBySeatForUpdate(@Param("ticket_seat") String ticket_seat);

    @Query("SELECT t FROM Ticket t WHERE t.ticket_seat = :ticketSeat")
    Optional<Ticket> findBySeat(@Param("ticketSeat") String ticketSeat);
